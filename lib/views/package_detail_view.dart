      ...
      child: Scaffold(
        body: Center(
          child: Column(
            ...
            children: [
              const Text('Welcome to the Package Details Screen!', textAlign: TextAlign.center, style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.of(context).pushNamed(AppRoutes.packageListing);
                },
                child: const Text('Go to Package Listing'),
              ),
              ElevatedButton(
                onPressed: () {
